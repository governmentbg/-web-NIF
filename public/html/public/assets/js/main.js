...
document.addEventListener("DOMContentLoaded", function () {
  ...
  elements.forEach(function (el) {
    var trigger = el.dataset.on || "scroll";
    if (trigger !== "hover") {
      el.style.opacity = "0";
  ...
  groups.forEach(function (group) {
    var children = group.querySelectorAll("[data-animation]");
  ...
  function playAnimation(el) {
    ...
    var repeat = el.dataset.repeat === "true";
    el.style.opacity = "1";
...
/* harmony import */ var _animations_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./animations.js */ "./resources/js/animations.js");
...
/* harmony import */ var _multiselect__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./multiselect */ "./resources/js/multiselect.js");


document.documentElement.classList.add("js");

document.addEventListener("DOMContentLoaded", function () {
  (0,_multiselect__WEBPACK_IMPORTED_MODULE_2__.initMultiSelectForm)("programs-filter");
});
...
var gridBtn = document.getElementById("grid-view-btn");
var listBtn = document.getElementById("list-view-btn");
var selectedGrid = localStorage.getItem("selectedGrid");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   initMultiSelectForm: () => (/* binding */ initMultiSelectForm)
/* harmony export */ });
function initMultiSelectForm(formId) {
  var form = document.getElementById(formId);
  if (!form) return;
  var containers = form.querySelectorAll(".dropdown-multiselect");
  containers.forEach(function (container) {
    var button = container.querySelector("button");
    var checkboxes = container.querySelectorAll("input[type='checkbox']");

    // Placeholder = първоначалния текст
    var placeholderText = button.textContent.trim();

    // Шаблон за избрани
    var selectedTextTemplate = button.dataset.selectedText || "{count} selected";
    function updateButton() {
      ...
      if (checkedCount === 0) {
        ...
        button.textContent = selectedTextTemplate.replace("{count}", checkedCount);
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/css/main"], () => (__webpack_require__("./resources/scss/app.scss")))
