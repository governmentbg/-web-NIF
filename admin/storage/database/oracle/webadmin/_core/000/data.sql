...
INSERT INTO permissions (perm, created) VALUES ('dashboard/errors', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('errors', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('modules', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('groups', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('journal', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('log', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('log/viewraw', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('mail', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('maildb', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('authentication', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('organization', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('permissions', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('settings', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('translation', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('uploads', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('users', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('pending', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('users/impersonate', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('users/master', SYSTIMESTAMP);
INSERT INTO permissions (perm, created) VALUES ('config', SYSTIMESTAMP);

INSERT INTO organization (lft, rgt, lvl, pid, pos, title) VALUES (1, 2, 0, NULL, 0, 'Корен');

INSERT INTO grps (name, created) VALUES ('Супер администратори', SYSTIMESTAMP);
INSERT INTO grps (name, created) VALUES ('Обикновени', SYSTIMESTAMP);

INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'dashboard/errors', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'errors', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'groups', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'journal', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'log', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'log/viewraw', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'mail', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'maildb', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'authentication', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'organization', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'permissions', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'settings', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'translation', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'uploads', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'users', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'pending', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'modules', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'users/impersonate', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'users/master', SYSTIMESTAMP);
INSERT INTO group_permissions (grp, perm, created) VALUES (1, 'config', SYSTIMESTAMP);

INSERT INTO user_groups (usr, grp, main, created) VALUES (1, 1, 1, SYSTIMESTAMP);
INSERT INTO user_groups (usr, grp, main, created) VALUES (1, 2, 0, SYSTIMESTAMP);

INSERT INTO user_organizations (usr, org) VALUES (1, 1);

INSERT INTO user_providers (provider, id, usr, name, data, created, used) VALUES ('PasswordDatabase', 'admin', 1, '', '$2y$10$98aIL6pV51r.HlzwIbJ7aeCUL9R8C0CmdtMeIc66VRGk8lA8O8k2.', SYSTIMESTAMP, NULL);
