...
INSERT INTO `tree_struct` (`id`, `lft`, `rgt`, `lvl`, `pid`, `pos`) VALUES (1, 1, 6, 0, NULL, 0);
INSERT INTO `tree_struct` (`id`, `lft`, `rgt`, `lvl`, `pid`, `pos`) VALUES (2, 2, 5, 1, 1, 0);
INSERT INTO `tree_struct` (`id`, `lft`, `rgt`, `lvl`, `pid`, `pos`) VALUES (3, 3, 4, 2, 2, 0);

INSERT INTO `sites` (`site`, `name`, `domains`, `tree`, `disabled`, `dflt`) VALUES (1, 'localhost', 'localhost', 3, 0, 1);

INSERT INTO `languages` (`lang`, `code`, `name`, `local`) VALUES (1, 'bg', 'Български', 'Български');
INSERT INTO `languages` (`lang`, `code`, `name`, `local`) VALUES (2, 'en', 'English', 'Английски');
