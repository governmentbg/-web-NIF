...
<div class="ui clearing basic segment title-segment">
    <h3 class="ui left floated red header kick-header">
        <i class="sign out alternate icon"></i>
        <span class="content"><?= $this->e($intl('users.kick.title')) ?></span>
    </h3>
</div>
<?php $this->stop() ?>
...
<div class="ui segment">
    <form class="ui form validate-form" method="post">
        ...
        <p class="kick-descr">
            <?= $this->e($intl('users.kick.description')) ?><br />
        ...
        <div class="ui center aligned red secondary segment">
            <button class="ui red icon labeled submit button">
                <i class="user icon"></i> <?= $this->e($intl('users.kick.continue')) ?>
            </button>
...
.kick-header { padding:0.5rem !important; }
.kick-descr { text-align:center; }
</style>
